...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function handleDownload(e) {
    ...
    const macDownloadUrl =
      "https://github.com/igmcdowell/WriteTime-releases/releases/download/v0.0.20/WriteTime-Mac-0.0.31-Installer.dmg";
    const windowsDownloadUrl =
      "https://github.com/igmcdowell/WriteTime-releases/releases/download/v0.0.20/WriteTime-Windows-0.0.31-Setup.exe";
  ...
  if (platformInfo) {
    ...
    if (platformText) {
      platformText.innerHTML = `<a href="${secondaryUrl}" class="secondary-download">Download for ${secondaryPlatform}</a>`;
    }
  }
